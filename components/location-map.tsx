          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground text-pretty">
                As aulas acontecem na Praia do Recreio, um dos melhores picos para 
                iniciantes no Rio de Janeiro. Ondas consistentes e ambiente seguro 
                para aprender.
              </p>
            </div>
