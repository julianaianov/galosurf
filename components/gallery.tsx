...
const mediaItems: MediaItem[] = [
  {
    ...
    alt: "Aluno surfando pela primeira vez"
  },
  {
    id: 2,
    type: "image",
  ...
  },
  {
    id: 3,
    type: "video",
    src: "https://www.instagram.com/reel/DIKRPVfuvhF/embed",
    thumbnail: "https://images.unsplash.com/photo-1531722569936-825d3dd91b15?w=400&q=80",
    alt: "Reel da Ingryd no Instagram"
  },
  {
    id: 4,
    type: "image",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Veja nossos alunos conquistando as ondas! Cada foto e vídeo conta uma história de superação.
          </p>
        </div>
